...
- (void)drawPieView:(CGContextRef)ctx{
    ...
    float angle_end = [self.angles[0] floatValue]*2*M_PI/100.0;
    ...
    angle_end = [self.angles[1] floatValue]*2*M_PI/100.0;
    ...
    angle_start = angle_end;
    angle_end = [self.angles[2] floatValue]*2*M_PI/100.0;
    ...
    angle_start = angle_end;
    angle_end = [self.angles[3] floatValue]*2*M_PI/100.0;
